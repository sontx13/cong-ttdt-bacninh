...
export const getInfors = "infors?current=1&pageSize=20&sort=sort,asc&app.id=11&active=true";

//QAS
export const getQAS = "qas?current=1&pageSize=20&app.id=11&sort=timeQ,desc&active=true";
